...
def create_inter_data(dataset, modes, meanshape_path=""):
    ...
    flame_codes_path = "/mnt/HDD3/nguyen/09_diffusion_based/diffusion-rig/infer_flame_codes/flame_M003_Neutral_0.pkl"
    custom_codes = read_flame(flame_codes_path)

    for exp in custom_codes["expression"]:
        ...
        # sadly this version of deca-flame cannot parse 100 dims of exp so 50
        code["exp"] = th.tensor(exp).unsqueeze(dim=0).to("cuda")
